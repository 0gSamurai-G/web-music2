...
import { FrontendAlbum, Song, API_BASE_URL } from '@/lib/api';
...
interface AlbumDetailPageClientProps {
  initialAlbum: FrontendAlbum;
  initialAlbums: FrontendAlbum[];
}

export default function AlbumDetailPageClient({ initialAlbum, initialAlbums }: AlbumDetailPageClientProps) {
  const [album] = useState<FrontendAlbum>(initialAlbum);
  const [tracks] = useState<Song[]>(initialAlbum.songs || []);
