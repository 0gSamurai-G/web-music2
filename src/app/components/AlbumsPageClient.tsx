...
import { FrontendAlbum } from '@/lib/api';

interface AlbumsPageClientProps {
  initialAlbums: FrontendAlbum[];
  initialYearsActive: string;
  initialStreams: string;
}

export default function AlbumsPageClient({ initialAlbums, initialYearsActive, initialStreams }: AlbumsPageClientProps) {
  const heroRef = useRef<HTMLDivElement>(null);
  const [albums] = useState<FrontendAlbum[]>(initialAlbums);
  const [yearsActive] = useState(initialYearsActive);
